  ...
  return (
    <div className="inline-flex items-center rounded-pill border border-border">
      ...
      <button
        ...
        className="px-2 h-11 min-h-11 flex items-center justify-center text-destructive hover:bg-destructive/10 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 text-lg"
        title="Удалить товар"
      >
        ×
      </button>
