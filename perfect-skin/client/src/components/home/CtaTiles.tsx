      ...
      <div className="container-app">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-20 md:mb-32">
          ...
          >
            ...
            <p className="text-body leading-body text-foreground mb-8 md:mb-10 opacity-90">
              Ответьте на 5 вопросов о типе кожи и задаче — соберём программу
              ухода из средств ISSEIMI и GLACÉE.
            </p>
            <button className="bg-foreground text-accent font-heading font-bold px-8 md:px-10 py-3 md:py-4 rounded-pill transition-opacity duration-200 hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary min-h-11 md:min-h-12">
              Начать подбор
            </button>
          </div>
          ...
          <div className="border border-border rounded-block p-10 md:p-16 bg-card transition-transform duration-300 hover:scale-97">
            ...
            <p className="text-body leading-body text-muted-foreground mb-8 md:mb-10">
              Опишите проблему и приложите фото. Специалист ответит и подберёт
              средства под вашу кожу.
            </p>
            <button className="bg-foreground text-card font-heading font-bold px-8 md:px-10 py-3 md:py-4 rounded-pill transition-opacity duration-200 hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary min-h-11 md:min-h-12">
              Записаться
            </button>
          </div>
        </div>
