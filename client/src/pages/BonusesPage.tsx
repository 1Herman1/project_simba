...
const LEVELS = [
  {
    ...
    perks: ['Начисление 5% с каждого заказа', 'Оплата до 10% заказа сибакоинами'],
  },
  {
    key: 'active',
    label: 'Активный',
    ...
    perks: ['Начисление 5% с каждого заказа', 'Оплата до 20% заказа сибакоинами', 'Приоритетная поддержка'],
  },
  {
    key: 'premium',
    label: 'Премиум',
    ...
    perks: ['Начисление 5% с каждого заказа', 'Оплата до 50% заказа сибакоинами', 'Приоритетная поддержка', 'Эксклюзивные акции'],
  },
]
