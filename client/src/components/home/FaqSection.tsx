...
const faqs = [
  ...
  },
  {
    ...
    a: 'Да! Действует программа лояльности Сибакоины. С каждой покупки начисляется 5% от суммы заказа сибакоинами (1 сибакоин = 1 рубль). Накопленными сибакоинами можно оплатить заказ — хоть целиком, если их хватает. У программы три уровня по накоплению: Новичок (0–999), Активный (1000–4999) и Премиум (5000+) — чем выше уровень, тем больше привилегий: приоритетная поддержка и эксклюзивные акции.',
  },
]
