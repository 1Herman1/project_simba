...
const faqs = [
  ...
  },
  {
    ...
    a: 'Да! Действует бонусная программа: 1% от каждой покупки возвращается бонусами. При накоплении 1000 бонусов — статус "Активный" (скидка 3%), при 5000 — "Премиум" (скидка 5%). Бонусами можно оплачивать до 30% заказа.',
  },
]
