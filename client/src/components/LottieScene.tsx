...
type Props = {
  ...
  /** true — вечная петля; число — сколько ДОПОЛНИТЕЛЬНЫХ проходов после первого
      (loop={1} = два прохода и стоп). Вечная петля уместна на загрузке, где
      движение и есть сообщение «идёт работа»; в пустом каталоге человек молча
      читает экран, и мотор рядом с единственной кнопкой отбирает внимание. */
  loop?: boolean | number
}
