      ...
      <div className="hidden md:block">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-4">
          ...
          <div className="flex items-center gap-5 flex-shrink-0">
            ...
            {/* Избранное */}
            <Link to="/favorites" aria-label="Избранное" className="text-navy-500 hover:text-amber-400 transition-all hover:scale-110">
            ...
            {/* Корзина */}
            <Link to="/cart" aria-label="Корзина" className="relative text-navy-500 hover:text-blue-300 transition-all hover:scale-110">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* Профиль */}
            <Link to="/profile" aria-label="Профиль" className="text-navy-500 hover:text-blue-300 transition-all hover:scale-110">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
