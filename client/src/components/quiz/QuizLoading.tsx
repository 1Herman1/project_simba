 ...
 * плотные скруглённые пятна по шкале navy, без контура. Сцена статична: прогресс
 * на этом экране несёт смена стадий текстом («Смотрим состав» -> «Сверяем с
 * возрастом» -> «Подбираем вариант»), и дублировать его движением картинки не
 * нужно. Скрыт от скринридера, статус несёт role="status" на контейнере.
 */
function SniffingDog() {
  return (
    <svg viewBox="0 0 260 170" aria-hidden="true" focusable="false" className="w-44 h-auto mx-auto mb-8">
      ...
      {/* следы перед носом — куда пёс идёт */}
