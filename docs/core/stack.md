...
Универсальная база: стартовый стек для НОВЫХ проектов.
Реальный стек конкретного проекта — в `docs/projects/<проект>/project.md`,
и он имеет приоритет над этим файлом.

---

## Стек по умолчанию (для новых проектов)
